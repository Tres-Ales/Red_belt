...
public:
  ...
  void AddQueriesStream(istream& query_input, ostream& 
...
const string doc2 = "moscow is the capital of the russian 
    federation";
...
void TestSearchServer(istream& document_input, istream& 
    query_input,
